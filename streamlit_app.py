...
def sample_analyze_entities(gcs_content_uri):
    ...
    Args:
      ...
      e.g. gs://[Your Bucket]/[/work/firm-progress-333610-8a6e7210503d (NLP API Key Json) (1).json]
    """
    credential_path = "/work/firm-progress-333610-8a6e7210503d (NLP API Key Json) (1).json"
...
def main():
    sample_analyze_entities("gs://cloud-samples-data/language/entity.txt")
